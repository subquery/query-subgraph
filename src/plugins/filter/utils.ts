...
export function getSupportOperators(fieldType: string): Operators[] {
  switch (fieldType) {
    ...
    case 'bytea':
      return [
        Operators.EQUAL_TO, Operators.NOT, Operators.GT, Operators.LT, Operators.GTE, Operators.LTE,
        Operators.IN, Operators.NOT_IN, Operators.CONTAINS, Operators.NOT_CONTAINS
      ];
    case 'int2':
    case 'int4':
    case 'int8':
    ...
    case 'text':
      return [
        Operators.EQUAL_TO, Operators.NOT, Operators.GT, Operators.LT, Operators.GTE, Operators.LTE,
        Operators.IN, Operators.NOT_IN,
        Operators.CONTAINS, Operators.CONTAINS_NOCASE, Operators.NOT_CONTAINS, Operators.NOT_CONTAINS_NOCASE,
        Operators.STARTS_WITH, Operators.STARTS_WITH_NOCASE, Operators.NOT_STARTS_WITH, Operators.NOT_STARTS_WITH_NOCASE,
        Operators.ENDS_WITH, Operators.ENDS_WITH_NOCASE, Operators.NOT_ENDS_WITH, Operators.NOT_ENDS_WITH_NOCASE
      ];
    default:
      return []
  }
